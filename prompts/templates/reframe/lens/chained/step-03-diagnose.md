---
name: 'Step 3 - Diagnose'
description: 'The agent does the hard thinking — runs 3 internal checks, then delivers ONE clear diagnosis'
---
...
│  ✓ READY TO CONTINUE                                    │
│                                                         │
│  → Press ENTER to proceed to Challenge                  │
└─────────────────────────────────────────────────────────┘"

**THEN STOP COMPLETELY. Do not ask questions. Do not wait for feedback. Do not start challenging. Wait for the system to inject the next step.**
